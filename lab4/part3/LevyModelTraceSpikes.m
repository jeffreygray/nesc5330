...
init_length = 9;        % No US or CS input (Prevents out of bounds errors 
                         % during callbacks)
CS_length = 30;         % Duration of CS input
US_length = 10;         % Duration of US input  
...
w2 = ones(totalTrials, 1) *w_G;    % weight vec for gran-purk synapse
...
for trial=1:totalTrials 
    ...
    w2(trial+1) = errcapF(w2(trial) - e_BC*error);
